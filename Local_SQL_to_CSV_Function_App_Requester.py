...
f'https://sql-to-csv.azurewebsites.net/api/HttpTrigger_Get_Number_of_Database_Rows?\
table={table}')
...
for rowBatch in rowBatches:
	...
	future = session.get('https://sql-to-csv.azurewebsites.net/api/HttpTrigger_SQL_to_CSV',\
